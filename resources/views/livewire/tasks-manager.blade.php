    ...
    <div class="kid-card h-fit lg:sticky lg:top-6">
        ...
        <form wire:submit="{{ $editingTaskId ? 'updateTask' : 'createTask' }}" class="mt-6 grid gap-4 md:grid-cols-2" autocomplete="off">
            ...
            <div class="md:col-span-2">
                ...
                <input wire:model.live="formTaskImage" type="file" accept=".jpeg,.jpg,.png,.webp,image/jpeg,image/png,image/webp" class="w-full rounded-xl border border-slate-300 px-3 py-2">
