<x-layouts.app :title="'Settings • Star Rewards'">
    <x-app-nav>
        ...
        <a href="{{ route('parent.settings.star-rewards') }}" class="kid-btn kid-btn-primary ring-4 ring-blue-200">Settings</a>
