    ...
    private function provisionStreakBonuses(int $parentId): void
    {
        $bonuses = [
            [
                ...
                'day_target' => 1,
                'bonus_type' => StreakBonus::TYPE_NO_BONUS,
            ...
            [
                ...
                'description' => 'Task points gain a 20% streak boost.',
                'day_target' => 7,
            ...
            [
                ...
                'description' => 'Task points gain a 30% streak boost.',
                'day_target' => 14,
                'bonus_type' => StreakBonus::TYPE_20_PERCENT_BONUS,
            ...
            [
                ...
                'description' => 'Task points gain a 30% streak boost.',
                'day_target' => 21,
                'bonus_type' => StreakBonus::TYPE_30_PERCENT_BONUS,
